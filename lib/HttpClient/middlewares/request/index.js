...
const toLowerObjectKeys_1 = require("../../../utils/toLowerObjectKeys");
...
exports.defaultsMiddleware = ({ baseURL, rawHeaders, params, timeout, retries, verbose, exponentialTimeoutCoefficient, initialBackoffDelay, exponentialBackoffCoefficient, httpsAgent }) => {
    const countByMetric = {};
    const headers = toLowerObjectKeys_1.toLowerObjectKeys(rawHeaders);
    return (ctx, next) => {
        ctx.config = {
            baseURL,
            ...
            headers: {
                ...headers,
                ...toLowerObjectKeys_1.toLowerObjectKeys(ctx.config.headers),
            },
            params: {
                ...params,
                ...ctx.config.params,
